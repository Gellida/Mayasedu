...
const Diccionarios = () => (
  <div className={styles.landingBg} style={{minHeight: '100vh'}}>
    ...
    <main style={{maxWidth: 1100, margin: '0 auto', padding: '120px 16px 0 16px'}}>
      <h1 style={{textAlign: 'center', fontWeight: 800, fontSize: '2.7rem', margin: '0 0 36px 0', color: '#C19A32'}}>Diccionarios y traductores  digitales: Chol-Español, Tzeltal-Español, Tzotzil-español

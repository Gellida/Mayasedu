  ...
  <header className={styles.header}>
    <div className={styles.logosGroup}>
      <div className={styles.logoContainer}>
        <Image src="/logo_mayasedu.png" alt="Logo" width={90} height={90} />
      </div>
      <div className={styles.logoContainer}>
    ...
    <nav className={styles.navMenu}>
      <Link href="/" className={styles.navTitle} style={{cursor: 'pointer', textDecoration: 'none', color: 'inherit'}}>
        MAYAS EDU
      </Link>
  <Link className={styles.navLink} href="/investigacion">Investigación</Link>
